...
@Component({
    ...
    template: `
        ...
        <div>
            <p>Курс разработан для студентов первого курса всех направлений обучения в НГТУ. Теоретический материал
                курса
                "Основы проектной деятельности" формирует систему знаний и практических навыков теории и практики
                проектной
                деятельности. Начиная с общего представления о том, что такое проектная деятельность, курс постепенно
                дает
                пошаговое руководство и ответы на такие вопросы, как: разрабатывать и реализовывать проекты различного
                типа,
                как уметь работать в команде и системно мыслить?
            </p>
            <p>
                Совершенно неважно, чем вы будете заниматься в своей профессиональной деятельности – исследованиями,
                проектированием машин и механизмов, разработкой приложений, программированием или модернизацией
                производства.
            </p>
            <p>
                После завершения курса будет проще не только решать профессиональные задачи, но и не бояться воплощать в
                жизнь
                новые идеи, поскольку будут понятны конкретные шаги по их реализации.
            </p>

            <p>
                Курс "Основы проектной деятельности" рассчитан на 2 семестра. Каждую неделю будет доступна новая тема
                курса:
                видеолекции, раскрывающие содержание каждой темы, презентации и конспекты, с которыми можно ознакомиться
                в
                любое удобное время. Все темы включают практические занятия, в которых предстоит ознакомиться с
                примерами
                решения типовых задач, а затем выполнить задания самостоятельно. Каждая тема завершается контрольным
                тестом,
