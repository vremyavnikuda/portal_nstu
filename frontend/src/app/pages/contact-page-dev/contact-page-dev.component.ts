      ...
      <div class="spacer" style="padding: 16px">
        <mat-card>
          <mat-card-content class="centered-icon">
            Если у Вас есть предложения по развитию функционала Портала , прошу
            связаться со мной.
          </mat-card-content>
        </mat-card>
      </div>
      <div class="spacer" style="padding: 16px">
        <mat-card>
          <mat-card-content class="centered-icon">
            ...
            <a
              mat-button
              href="https://github.com/vremyavnikuda"
              target="_blank"
              >vremyavnikuda</a
            >
          </mat-card-content>
      ...
      <div class="spacer" style="padding: 16px">
        <mat-card>
          <mat-card-content class="centered-icon">
            ...
            <a mat-button href="https://t.me/vremayvnikuda" target="_blank"
              >vremyavnikuda</a
            >
          </mat-card-content>
        </mat-card>
